...
<div class="container p-4">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="detail" id="detail" rows="5" placeholder="Soạn nội dung bài viết...">{{ old('detail') }}</textarea>
        </div>
        <!-- Ảnh -->
        <div class="mb-3">
        ...
        <!-- Phần Kích Cỡ & Số Lượng (quản lý qua product_sizes) -->
        <div class="mb-3">
