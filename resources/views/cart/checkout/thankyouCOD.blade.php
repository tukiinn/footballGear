...
<!-- Custom CSS cho giao diện dark và hiệu ứng viền mờ -->
<style>
  ...
  /* Ghi đè dark theme cho bảng trong card (nếu có) */
  .card .table td,
  .card .table th {
  ...
  /* Ticket (Thank You Section) Style */
  .ticket {
    max-width: 800px;
    margin: 30px auto;
    background-color: #2c2c2c;
  ...
  <div class="ticket">
    ...
    <div class="ticket-body">
      ...
      <div class="info">
        ...
        <span>{{ $statusMapping[$order->trang_thai] ?? $order->trang_thai }}</span>
      </div>
    </div>
  </div>
</div>
